...
2. **Rachel, 47, high-school teacher** — burned out after a six-year stretch with no break. Knows she should meditate, hasn't managed it.
...
>
> *Look at the three artefacts. Stay fully in character. Do not break character or add meta-commentary about being an AI. Respond in first person.*
>
...
|---------------------------------------------------------|-------------------------------------|---------|
| "Welcome to your wellness journey" copy reads patronising | Sam, Rachel, Mark, Tenzin (4/6)   | High    |
...
| Tradition-stripped framing reads as marketing copy      | Tenzin (1/6)*                       | Low — but the only lens that could spot it |
```

*Sole-owner finding from the lens unique to a long-term practitioner.

## Step 5 — prose synthesis + action distribution

Every persona who would actually benefit from meditation is the one this onboarding scares off. Rachel — the burnt-out teacher who fits the target market — hits the paywall mid-crisis-week and churns angrily: *"day five is the worst possible day to ask me for money. I am exactly the user you want, the one who's actually building a habit, and that's the day you cash in your relationship with me."* Priya (the anxious student) flags the streak-loss notification as exactly the kind of language that triggers what she came to the app to manage. Tenzin's single-voice finding — *"the teacher who taught me said meditation is not a streak. You are gamifying the one thing that's meant to be free of games"* — is the lens no one else could provide.

Sam opens the app twice in a week, both for under a minute, then deletes on day four. Rachel completes four days, hits the paywall, churns. Tenzin deletes after onboarding. Priya starts a free trial intending to cancel; the day-6 streak-loss notification triggers her exactly the way she didn't want. Mark tests on two separate days and never converts. Dr Liu completes the week professionally and decides not to recommend the app to anxious patients — the streak language is the deal-breaker.

Across six personas: zero conversions, two angry churns, two quiet abandonments, one professional non-recommend.
...
- Reframe the product strategy first — these findings suggest the streak mechanic is fundamentally off
