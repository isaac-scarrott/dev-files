...
- If AWS credentials are expired/missing, refresh them yourself with `aws sso login` (e.g. `aws sso login --profile holibob` on Holibob work) — don't stop to ask me.
